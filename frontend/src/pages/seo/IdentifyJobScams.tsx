...
const IdentifyJobScams = () => {
  const faqItems = [
  {
    "question": "How do I spot a job scam?",
    "answer": "Look for red flags like requests for money, unofficial email domains, and lack of technical interviews."
  }
];
  const breadcrumbItems = [
  {
    "name": "Safety",
    "item": "/identifyjobscams"
  },
  {
    "name": "Scam Guide",
    "item": "/identifyjobscams"
  ...
  return (
    <SEOLayout
      title="How to Identify Job Scams in Hyderabad | Speshway Guide"
      description="Learn how to identify fake job scams in Hyderabad. Speshway Solutions provides a comprehensive guide to protecting yourself from recruitment fraud."
      keywords="Identify job scams Hyderabad, fake job offers, Speshway Solutions recruitment, Speshway fake jobs, zero fee hiring"
      canonical="/identifyjobscams"
      h1="How to Identify Job Scams: A Guide by Speshway Solutions"
      faqItems={faqItems}
...
export default IdentifyJobScams;
