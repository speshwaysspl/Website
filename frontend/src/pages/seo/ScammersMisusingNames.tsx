...
const ScammersMisusingNames = () => {
  const faqItems = [
  {
    "question": "Why do scammers use real company names?",
    "answer": "To build instant trust and credibility while deceiving victims into paying for fake services."
  }
];
  const breadcrumbItems = [
  {
    "name": "Security",
    "item": "/how-scammers-misuse-company-names"
  },
  {
    "name": "Impersonation",
    "item": "/how-scammers-misuse-company-names"
...
export default ScammersMisusingNames;
