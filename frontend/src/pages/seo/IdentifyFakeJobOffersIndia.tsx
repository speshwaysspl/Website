...
const IdentifyFakeJobOffersIndia = () => {
  const faqItems = [
  {
    "question": "What are the common signs of fake job offers in India?",
    "answer": "Common signs include demands for 'security deposits', offers that seem too good to be true, and recruiters using WhatsApp for formal hiring."
  }
];
  const breadcrumbItems = [
  {
    "name": "Safety",
    "item": "/top-10-ways-to-identify-fake-job-offers-india"
  },
  {
    "name": "India Guide",
    "item": "/top-10-ways-to-identify-fake-job-offers-india"
...
export default IdentifyFakeJobOffersIndia;
