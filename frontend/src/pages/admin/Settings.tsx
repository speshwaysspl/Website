...
const SettingsPage = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: async (payload: { heroTitleColor?: string; heroSubtitleColor?: string }) => {
  ...
  const handleSave = async () => {
    try {
      await api.put('/settings', { heroTitleColor, heroSubtitleColor });
              ...
              <CardContent className="space-y-6">
                ...
                <div className="pt-4">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="mt-1" style={{ color: heroSubtitleColor || undefined }}>Speshway Solutions delivers innovative IT solutions that drive digital transformation and accelerate business growth in the modern era.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
